...
public class Ventana extends JFrame{
	...
	private JMenu jMenu;
	private JMenuItem addContactItem,guardarAgendaItem,cargarAgendaItem;
	...
	public void initComponents(){
		...
		guardarAgendaItem= new JMenuItem("Guardar Agenda");
		guardarAgendaItem.addActionListener(new SaveAgendaListener());
		cargarAgendaItem= new JMenuItem("Cargar Agenda");
		cargarAgendaItem.addActionListener(new CargarAgendaListener());
		jMenu.add(addContactItem);
		jMenu.add(guardarAgendaItem);
		jMenu.add(cargarAgendaItem);
	...
	public class SaveAgendaListener implements ActionListener{
		public void actionPerformed(ActionEvent e){
			try{
